  ...
  return (
    <div className='relative mt-20 border-b border-neutral-900 min-h-[800px]'>
        <div className="text-center">
            ...
            <h2 className="text-xl sm:text-5xl lg:text-6xl mt-10 lg:mt-15 tracking-wide">
                Build Your 
                <span className='bg-gradient-to-r from-purple-500 to-orange-600 text-transparent bg-clip-text'>{" "} Code Now</span>
            </h2>
        </div>
